 ...
 */
class Acceso extends \Backend\UserBundle\Entity\Acceso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Backend\\UserBundle\\Entity\\Acceso' . "\0" . 'id', '' . "\0" . 'Backend\\UserBundle\\Entity\\Acceso' . "\0" . 'name', '' . "\0" . 'Backend\\UserBundle\\Entity\\Acceso' . "\0" . 'acceso', 'groups');
        }
