...
class Producto 
{
     ...
     * @return Producto
     */
    public function addSucursale(\Backend\CustomerAdminBundle\Entity\Sucursales $sucursales)
    {
     ...
     * @param \Backend\CustomerAdminBundle\Entity\Sucursales $sucursales
     */
    public function removeSucursale(\Backend\CustomerAdminBundle\Entity\Sucursales $sucursales)
    {
